    ...
    <div style={{ width: 350, }}>
      <Row className="mb-5">
        ...
        <Form onSubmit={validate(handleSubmit)}>
          <Form.Group className="mb-3" style={{ width: "200px" }} controlId="formBasicEmail">
          ...
          <Row className="mb-3 w-50 ">
            <Form.Group className="mb-3" as={Col} controlId="formPeopleAmount" >
              ...
              <Form.Control {...register("people Amount", { required: true })}
                value={peopleAmount} onChange={e => setPeopleAmount(e.target.value)} type="number" min="0" placeholder="Enter people Amount"
              />
            </Form.Group>
            <Form.Group as={Col} controlId="maxPeopleAmount"
              ...
              <Form.Control
                ...
                value={maxPeopleAmount} onChange={e => setMaxPeopleAmount(e.target.value)} type="number" min="0" placeholder="Enter people Amount"
              />
              {errors.peopleAmount && (
                <small className="d-block form-text text-danger mt-2">
          ...
          {status === "Busy" && (
            <Form.Group style={{ display: !status === "Busy" }} className="w-20" controlId="formBasicEmail">
              ...
              <Form.Control {...register("Bill ", { required: true, minLength: 1 })}
                value={status === "Busy" ? bill : 0} onChange={e => setBill(e.target.value)} type="number" placeholder="Enter bill"
              />
            </Form.Group>
          )}
        </Form>
